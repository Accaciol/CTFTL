const CHAPTER_SUMMARIES = {
  "1": "<h1>📚 Capítulo 1: Fundamentos de Testes (Syllabus CTFL v4.0)</h1>\n<p>Este capítulo apresenta a base teórica, os objetivos, os princípios essenciais, a psicologia dos testes e as práticas modernas introduzidas pelo <strong>Syllabus CTFL 4.0</strong> (como <em>Whole-Team Approach</em> e <em>Shift-Left</em>).</p>\n<hr/>\n<h2>1. O que é Teste de Software?</h2>\n<p>O teste de software é um conjunto de atividades lógicas e sistemáticas destinadas a avaliar a qualidade de um produto de software e reduzir os riscos de falhas em operação. <strong>Teste não é apenas a execução de testes</strong> (rodar o código e comparar saídas), mas sim um processo contínuo que abrange planejamento, análise, modelagem, implementação, execução, avaliação de critérios de saída e encerramento.</p>\n<h3>1.1 Objetivos Principais do Teste</h3>\n<ul>\n<li><strong>Prevenir Defeitos</strong>: Identificar problemas precocemente antes da codificação (ex.: revisões estáticas de requisitos e histórias de usuário).</li>\n<li><strong>Verificação</strong>: Confirmar se os requisitos especificados foram atendidos (<em>\"Construímos o produto corretamente?\"</em>).</li>\n<li><strong>Validação</strong>: Garantir que o sistema atende às necessidades reais dos usuários em seu ambiente operacional (<em>\"Construímos o produto certo?\"</em>).</li>\n<li><strong>Construir Confiança</strong>: Prover evidências sobre o nível de qualidade atingido pelo produto para os <em>stakeholders</em>.</li>\n<li><strong>Reduzir Riscos</strong>: Descobrir falhas para que os riscos operacionais e de negócio sejam mitigados a níveis aceitáveis.</li>\n<li><strong>Fornecer Informações para Decisão</strong>: Gerar relatórios e métricas que apoiem a tomada de decisão sobre o lançamento do software.</li>\n<li><strong>Garantir Conformidade</strong>: Cumprir normas contratuais, legais ou regulatórias aplicáveis ao setor.</li>\n</ul>\n<h3>1.2 Teste vs. Depuração (Debugging)</h3>\n<div class=\"table-responsive\"><table class=\"reader-table\"><thead><tr>\n<th>Atividade</th>\n<th>Responsável Principal</th>\n<th>Foco / Objetivo</th>\n</tr></thead><tbody>\n<tr>\n<td><strong>Teste</strong></td>\n<td>Testadores / Equipe de QA</td>\n<td>Mostrar falhas que revelam a presença de defeitos nos artefatos ou no código em execução.</td>\n</tr>\n<tr>\n<td><strong>Depuração (Debugging)</strong></td>\n<td>Desenvolvedores</td>\n<td>Localizar a causa raiz do problema (o defeito no código), analisar seu impacto e corrigi-lo.</td>\n</tr>\n</tbody></table></div>\n<hr/>\n<h2>2. Abordagens Modernas do CTFL 4.0</h2>\n<h3>2.1 Abordagem de Toda a Equipe (<em>Whole-Team Approach</em>)</h3>\n<p>No contexto ágil e moderno do CTFL 4.0, a garantia da qualidade <strong>não é responsabilidade exclusiva dos testadores</strong>, mas sim de <strong>toda a equipe</strong> (desenvolvedores, analistas de negócio, Product Owner e QA).</p>\n<ul>\n<li>Qualquer membro do time pode assumir tarefas de teste e qualidade.</li>\n<li>Os testadores atuam como <strong>mentores e facilitadores de qualidade</strong>, guiando a equipe em boas práticas.</li>\n</ul>\n<h3>2.2 Deslocamento à Esquerda (<em>Shift-Left</em>)</h3>\n<p>O princípio de <em>Shift-Left</em> defende a antecipação de todas as atividades de teste para as fases mais iniciais do Ciclo de Vida de Desenvolvimento (SDLC).</p>\n<ul>\n<li>Testes começam no refinamento de requisitos e na especificação de Histórias de Usuário.</li>\n<li><strong>Vantagem</strong>: Quanto mais cedo um defeito for detectado, exponencialmente menor será o custo e o impacto de sua correção.</li>\n</ul>\n<hr/>\n<h2>3. Erros, Defeitos e Falhas</h2>\n<p>A cadeia causal de problemas no software é descrita por:</p>\n<p>$$\\text{Erro (Engano Humano)} \\longrightarrow \\text{Defeito / Bug (No Artefato / Código)} \\longrightarrow \\text{Falha (Comportamento Incorreto em Execução)}$$</p>\n<ul>\n<li><strong>Erro (Engano)</strong>: Ação humana incorreta cometida por um desenvolvedor, analista ou designer (ex.: má interpretação de uma regra de negócio).</li>\n<li><strong>Defeito (Bug / Imperfeição)</strong>: A manifestação do erro gravada em um produto de trabalho (código-fonte, documento de especificação, caso de teste).</li>\n<li><strong>Falha</strong>: Um desvio funcional ou operacional em tempo de execução onde o sistema não realiza o comportamento esperado. <em>Nem todo defeito gera falha</em> (ex.: código morto não executado).</li>\n<li><strong>Causa Raiz</strong>: A razão fundamental que deu origem ao erro humano (ex.: falta de treinamento, fadiga, especificação ambígua).</li>\n</ul>\n<hr/>\n<h2>4. Os 7 Princípios Fundamentais do Teste</h2>\n<ol>\n<li><strong>O teste mostra a presença de defeitos, não a sua ausência</strong>: Testar pode provar que existem defeitos, mas nunca provar que o software está $100\\%$ livre de erros.</li>\n<li><strong>O teste exaustivo é impossível</strong>: Testar todas as combinações de entradas, caminhos e pré-condições é inviável na prática. Utiliza-se análise de risco e priorização.</li>\n<li><strong>O teste antecipado economiza tempo e dinheiro (<em>Shift-Left</em>)</strong>: Iniciar os testes no início do SDLC previne a propagação de defeitos custosos.</li>\n<li><strong>Agrupamento de defeitos (<em>Defect Clustering</em>)</strong>: A maioria dos defeitos operacionais concentra-se em um pequeno número de módulos (Princípio de Pareto: 80% das falhas estão em 20% do código).</li>\n<li><strong>O paradoxo do pesticida</strong>: Testes repetidos da mesma forma deixam de encontrar novos defeitos. Os casos de teste devem ser continuamente atualizados.</li>\n<li><strong>O teste depende do contexto</strong>: A estratégia de teste para um aplicativo bancário é completamente diferente da estratégia para um jogo casual ou software médico.</li>\n<li><strong>A ilusão da ausência de erros</strong>: Encontrar e corrigir defeitos não garante o sucesso do produto se o sistema for difícil de usar ou não atender às necessidades reais do cliente.</li>\n</ol>\n<hr/>\n<h2>5. O Processo de Teste</h2>\n<p>O processo de teste é composto por 7 atividades iterativas:</p>\n<pre class=\"code-block mermaid\"><code>\nflowchart LR\nA[1. Planejamento] --&gt; B[2. Monitoramento e Controle]\nB --&gt; C[3. Análise de Teste]\nC --&gt; D[4. Modelagem / Test Design]\nD --&gt; E[5. Implementação]\nE --&gt; F[6. Execução]\nF --&gt; G[7. Encerramento]\n</code></pre>\n<ol>\n<li><strong>Planejamento de Testes</strong>: Define os objetivos, o escopo, os recursos, a abordagem e o cronograma.</li>\n<li><strong>Monitoramento e Controle de Testes</strong>: Acompanha o progresso real em relação ao planejado por meio de métricas e aplica ações corretivas.</li>\n<li><strong>Análise de Teste</strong>: Avalia a base de teste (requisitos, arquitetura) para identificar <em>\"o que testar\"</em> (condições de teste).</li>\n<li><strong>Modelagem de Teste (<em>Test Design</em>)</strong>: Transforma condições de teste em casos de teste detalhados e dados de teste necessários (<em>\"como testar\"</em>).</li>\n<li><strong>Implementação de Teste</strong>: Cria suítes de teste, organiza os scripts automatizados e valida o ambiente de teste.</li>\n<li><strong>Execução de Teste</strong>: Executa as suítes manuais ou automatizadas, compara resultados reais com esperados e registra defeitos.</li>\n<li><strong>Encerramento de Teste</strong>: Avalia critérios de saída, consolida relatórios finais, arquiva <em>testware</em> e identifica lições aprendidas.</li>\n</ol>\n<hr/>\n<h2>6. Psicologia dos Testes e Rastreabilidade</h2>\n<h3>6.1 Psicologia do Testador e Vieses Cognitivos</h3>\n<ul>\n<li><strong>Independência do Teste</strong>: Autores tendem a ter <em>viés de confirmação</em> ao testar o próprio código. Testadores independentes (equipes dedicadas ou externas) trazem visões neutras e descobrem falhas ocultas.</li>\n<li><strong>Comunicação Construtiva</strong>: Os relatórios de defeitos devem ser objetivos, impessoais e focados no artefato, nunca na pessoa do desenvolvedor.</li>\n<li><strong>Habilidades Essenciais</strong>: Curiosidade técnica, ceticismo saudável, atenção aos detalhes e excelente comunicação interpessoal.</li>\n</ul>\n<h3>6.2 Rastreabilidade Bidirecional</h3>\n<p>Estabelecer rastreabilidade bidirecional entre a <strong>Base de Teste</strong> (Requisitos), <strong>Condições de Teste</strong>, <strong>Casos de Teste</strong>, <strong>Execuções</strong> e <strong>Defect Reports</strong>:</p>\n<ul>\n<li>Permite medir a cobertura efetiva dos requisitos.</li>\n<li>Facilita a análise de impacto de mudanças de requisitos.</li>\n<li>Auditoria e governança transparente do progresso de QA.</li>\n</ul>",
  "2": "<h1>📚 Capítulo 2: Testes ao Longo do Ciclo de Vida (SDLC) (Syllabus CTFL v4.0)</h1>\n<p>Este capítulo aborda como as atividades de teste se integram aos diferentes modelos de desenvolvimento (Sequenciais, Iterativos/Ágeis e DevOps), detalhando os <strong>Níveis de Teste</strong>, <strong>Tipos de Teste</strong> e modelos conceituais modernos como a <strong>Pirâmide de Testes</strong> e os <strong>Quadrantes de Teste</strong>.</p>\n<hr/>\n<h2>1. Testes no Contexto do SDLC</h2>\n<p>Para cada atividade de desenvolvimento de software, deve haver uma atividade de teste correspondente. A forma como os testes são organizados varia de acordo com o modelo de SDLC adotado.</p>\n<h3>1.1 Modelos Sequenciais vs. Iterativos/Ágeis</h3>\n<ul>\n<li><strong>Modelos Sequenciais (Ex.: Modelo V, Cascata)</strong>:</li>\n<li>Desenvolvimento em fases bem definidas e cascateadas.</li>\n<li>Testes dinâmicos ocorrem principalmente em fases posteriores.</li>\n<li>O <strong>Modelo V</strong> associa diretamente cada fase de desenvolvimento ao seu nível de teste correspondente (ex.: Requisitos de Usuário $\\leftrightarrow$ Teste de Aceite; Código $\\leftrightarrow$ Teste de Componente).</li>\n<li><strong>Modelos Iterativos/Ágeis (Ex.: Scrum, Kanban)</strong>:</li>\n<li>O software é construído em pequenas iterações (Sprints de 1 a 4 semanas).</li>\n<li>As atividades de teste são contínuas e integradas diariamente à equipe (<em>Whole-Team Approach</em>).</li>\n<li>Ênfase em <strong>Automação de Testes de Regressão</strong> e integração contínua (CI/CD).</li>\n</ul>\n<h3>1.2 DevOps, CI/CD e Shift-Left / Shift-Right</h3>\n<ul>\n<li><strong>CI/CD (Integração e Entrega Contínuas)</strong>: Permite que testes automatizados sejam executados a cada <em>commit</em> ou <em>pull request</em>, fornecendo feedback imediato aos desenvolvedores.</li>\n<li><strong>Shift-Left</strong>: Antecipa testes para as fases de requisitos e arquitetura.</li>\n<li><strong>Shift-Right</strong>: Estende as práticas de qualidade para o ambiente de <strong>Produção</strong> (ex.: testes A/B, monitoramento de saúde do sistema, engenharias de caos e testes de observabilidade).</li>\n</ul>\n<hr/>\n<h2>2. Modelos Conceituais de Teste (CTFL 4.0)</h2>\n<h3>2.1 Pirâmide de Testes (<em>Test Pyramid</em>)</h3>\n<p>A Pirâmide de Testes visualiza a proporção ideal de diferentes níveis de testes automatizados:</p>\n<pre class=\"code-block mermaid\"><code>\npyramid\ntop: Testes de UI / E2E (Poucos, mais lentos, custo alto)\nmiddle: Testes de Integração / API (Quantidade moderada)\nbase: Testes de Componente / Unitários (Muitos, rápidos, baixo custo)\n</code></pre>\n<ul>\n<li><strong>Base (Testes Unitários/Componente)</strong>: Maior volume de testes. Execução ultrarrápida, alta isolamento e baixo custo de manutenção.</li>\n<li><strong>Meio (Testes de Integração/Serviços/API)</strong>: Valida a comunicação entre módulos ou serviços.</li>\n<li><strong>Topo (Testes End-to-End / UI)</strong>: Menor quantidade de testes. Valida fluxos completos de negócio, porém são mais lentos e sujeitos a instabilidades (<em>flaky tests</em>).</li>\n</ul>\n<h3>2.2 Quadrantes de Teste (<em>Testing Quadrants</em>)</h3>\n<p>Propostos por Brian Marick, os 4 Quadrantes ajudam a organizar os tipos de teste segundo o <strong>foco</strong> (Apoio à Equipe vs. Critica ao Produto) e a <strong>perspectiva</strong> (Negócio vs. Tecnologia):</p>\n<div class=\"table-responsive\"><table class=\"reader-table\"><thead><tr>\n<th></th>\n<th><strong>Apoio à Equipe (Guiam o Dev)</strong></th>\n<th><strong>Crítica ao Produto (Avaliam o Produto)</strong></th>\n</tr></thead><tbody>\n<tr>\n<td><strong>Guiados pelo Negócio</strong></td>\n<td><strong>Q2</strong>: Histórias de Usuário, Protótipos, Exemplos, ATDD/BDD.</td>\n<td><strong>Q3</strong>: Teste de Aceite do Usuário (UAT), Usabilidade, Testes Exploratórios.</td>\n</tr>\n<tr>\n<td><strong>Guiados pela Tecnologia</strong></td>\n<td><strong>Q1</strong>: Testes Unitários, Testes de Componente, TDD, Análise Estática.</td>\n<td><strong>Q4</strong>: Testes Não-Funcionais (Desempenho, Carga, Segurança, Confiabilidade).</td>\n</tr>\n</tbody></table></div>\n<hr/>\n<h2>3. Níveis de Teste</h2>\n<p>Um Nível de Teste é um conjunto de atividades de teste gerenciadas e executadas como um grupo. No Syllabus v4.0, destacam-se:</p>\n<h3>3.1 Teste de Componente (Unitário)</h3>\n<ul>\n<li><strong>Foco</strong>: Módulos individuais, classes, funções ou métodos isolados.</li>\n<li><strong>Base de Teste</strong>: Código-fonte, design detalhado, modelos de dados.</li>\n<li><strong>Objetivo</strong>: Reduzir risco de erros lógicos nos blocos básicos de código.</li>\n<li><strong>Responsável</strong>: Desenvolvedores (frequentemente usando TDD - <em>Test-Driven Development</em>).</li>\n</ul>\n<h3>3.2 Teste de Integração</h3>\n<ul>\n<li><strong>Foco</strong>: Interações e interfaces entre componentes ou sistemas.</li>\n<li><strong>Tipos</strong>:</li>\n<li><strong>Integração de Componentes</strong>: Valida a comunicação entre módulos internos.</li>\n<li><strong>Integração de Sistemas</strong>: Valida a comunicação entre sistemas heterogêneos, APIs REST, microserviços e bancos de dados externos.</li>\n<li><strong>Objetivo</strong>: Detectar defeitos nas interfaces e protocolos de troca de dados.</li>\n</ul>\n<h3>3.3 Teste de Sistema</h3>\n<ul>\n<li><strong>Foco</strong>: O comportamento do produto de software completo e integrado como um todo.</li>\n<li><strong>Base de Teste</strong>: Especificações de requisitos de sistema, casos de uso, arquitetura de software.</li>\n<li><strong>Objetivo</strong>: Verificar o cumprimento dos requisitos funcionais e não-funcionais globais em ambiente similar ao de produção.</li>\n</ul>\n<h3>3.4 Teste de Aceite</h3>\n<ul>\n<li><strong>Foco</strong>: Avaliar se o sistema está pronto para implantação e se atende às necessidades de negócio.</li>\n<li><strong>Subtipos</strong>:</li>\n<li><strong>Teste de Aceite do Usuário (UAT)</strong>: Realizado por usuários finais para validar requisitos de negócio.</li>\n<li><strong>Teste de Aceite Operacional (OAT)</strong>: Realizado por administradores de sistemas/DevOps (focado em backup/restauração, recuperação de desastres, instalação, segurança).</li>\n<li><strong>Teste de Aceite Contratual e Regulatório</strong>: Valida conformidade com normas legais ou cláusulas contratuais.</li>\n<li><strong>Testes Alfa e Beta</strong>: Alfa (na organização por usuários/clientes) e Beta (em ambiente externo por clientes reais).</li>\n</ul>\n<hr/>\n<h2>4. Tipos de Testes</h2>\n<h3>4.1 Testes Funcionais</h3>\n<ul>\n<li>Avaliam <strong>o que</strong> o software faz. Baseados em requisitos funcionais e regras de negócio.</li>\n<li>Aplicáveis a todos os níveis de teste.</li>\n</ul>\n<h3>4.2 Testes Não-Funcionais</h3>\n<ul>\n<li>Avaliam <strong>como</strong> o software se comporta (qualidade de serviço).</li>\n<li>Incluem: Desempenho, Carga, Estresse, Segurança, Usabilidade, Acessibilidade, Portabilidade e Mantibilidade.</li>\n</ul>\n<h3>4.3 Testes de Caixa-Branca (<em>White-Box</em>)</h3>\n<ul>\n<li>Baseiam-se na estrutura interna do código, arquitetura ou fluxo de controle.</li>\n<li>Medidos por métricas de cobertura (instruções/sentenças e decisões/ramos).</li>\n</ul>\n<h3>4.4 Teste de Confirmação (Re-teste) vs. Teste de Regressão</h3>\n<ul>\n<li><strong>Teste de Confirmação (Re-teste)</strong>: Executado para verificar se um defeito específico reportado anteriormente foi corrigido com sucesso.</li>\n<li><strong>Teste de Regressão</strong>: Executado em partes <strong>não alteradas</strong> do sistema para garantir que modificações, melhorias ou correções recentes não introduziram novos defeitos secundários.</li>\n</ul>\n<hr/>\n<h2>5. Teste de Manutenção</h2>\n<p>O teste de manutenção é realizado em sistemas existentes em produção quando ocorrem mudanças.</p>\n<h3>Gatilhos para Testes de Manutenção</h3>\n<ol>\n<li><strong>Modificações</strong>: Correções de bugs, melhorias funcionais, patches de segurança.</li>\n<li><strong>Migração</strong>: Mudança de plataforma, banco de dados, sistema operacional ou infraestrutura de nuvem.</li>\n<li><strong>Aposentadoria (Desativação)</strong>: Retirada de circulação de um sistema ou arquivamento de dados históricos.</li>\n</ol>\n<ul>\n<li><strong>Análise de Impacto</strong>: Avaliação necessária para identificar quais partes do sistema podem ser afetadas por uma mudança e determinar o escopo dos testes de regressão necessários.</li>\n</ul>",
  "3": "<h1>📚 Capítulo 3: Teste Estático (Syllabus CTFL v4.0)</h1>\n<p>Este capítulo examina as técnicas de <strong>teste estático</strong>, que abrangem revisões humanas e análise estática automatizada de produtos de trabalho sem a necessidade de executar o código-fonte.</p>\n<hr/>\n<h2>1. O que é Teste Estático?</h2>\n<p>Diferente do teste dinâmico (que exige a execução do software em um computador), o teste estático analisa artefatos de software (requisitos, arquitetura, código, histórias de usuário, planos de teste) para <strong>encontrar defeitos diretamente</strong>, antes que eles se convertam em falhas operacionais.</p>\n<h3>1.1 Teste Estático vs. Teste Dinâmico</h3>\n<div class=\"table-responsive\"><table class=\"reader-table\"><thead><tr>\n<th>Característica</th>\n<th>Teste Estático</th>\n<th>Teste Dinâmico</th>\n</tr></thead><tbody>\n<tr>\n<td><strong>Execução</strong></td>\n<td>Sem execução de código.</td>\n<td>Requer execução do código em ambiente controlado.</td>\n</tr>\n<tr>\n<td><strong>Alvo Principal</strong></td>\n<td>Encontra <strong>Defeitos</strong> diretamente nos artefatos.</td>\n<td>Mostra <strong>Falhas</strong> causadas por defeitos no código.</td>\n</tr>\n<tr>\n<td><strong>Momento de Aplicação</strong></td>\n<td>Muito precoce no SDLC (<em>Shift-Left</em>).</td>\n<td>Após a construção de módulos ou componentes executáveis.</td>\n</tr>\n<tr>\n<td><strong>Custo de Correção</strong></td>\n<td>Extremamente baixo (previne a propagação de erros).</td>\n<td>Mais elevado (requer depuração, re-compilação e re-testes).</td>\n</tr>\n<tr>\n<td><strong>Exemplos de Defeitos</strong></td>\n<td>Contradições em requisitos, falhas de segurança no código, desvios de padrão, código morto.</td>\n<td>Estouro de memória, falha de cálculo em tempo de execução, timeouts de rede.</td>\n</tr>\n</tbody></table></div>\n<hr/>\n<h2>2. Processo de Revisão</h2>\n<p>As revisões humanas variam da conversa informal até inspeções altamente estruturadas.</p>\n<h3>2.1 As 6 Etapas do Processo Formal de Revisão</h3>\n<pre class=\"code-block mermaid\"><code>\nflowchart LR\nA[1. Planejamento] --&gt; B[2. Início / Kick-off]\nB --&gt; C[3. Revisão Individual]\nC --&gt; D[4. Comunicação de Questões]\nD --&gt; E[5. Correção / Rework]\nE --&gt; F[6. Conclusão / Closure]\n</code></pre>\n<ol>\n<li><strong>Planejamento</strong>: Definição do escopo, alocação de papéis, estimativa de tempo e avaliação de critérios de entrada.</li>\n<li><strong>Início (Kick-off)</strong>: Distribuição do produto de trabalho e explicação dos objetivos aos revisores.</li>\n<li><strong>Revisão Individual</strong>: Cada revisor analisa o documento isoladamente, identificando potenciais defeitos, dúvidas e observações.</li>\n<li><strong>Comunicação e Registro de Questões</strong>: Reunião presencial/remota para discutir os achados, consolidar a lista de defeitos e decidir sobre ações.</li>\n<li><strong>Correção (Rework)</strong>: O autor corrige os defeitos aceitos na lista.</li>\n<li><strong>Conclusão (Closure)</strong>: Verificação das correções contra critérios de saída para aprovação final do documento.</li>\n</ol>\n<h3>2.2 Papéis em uma Revisão Formal</h3>\n<ul>\n<li><strong>Autor</strong>: Criador do produto de trabalho a ser revisado (corrige os defeitos encontrados).</li>\n<li><strong>Gerente</strong>: Decide sobre a realização da revisão, aloca tempo e orçamento.</li>\n<li><strong>Líder da Revisão (<em>Review Leader</em>)</strong>: Assume a responsabilidade geral pela condução da revisão (organiza a equipe e prazos).</li>\n<li><strong>Facilitador (Moderador)</strong>: Garante a neutralidade, media discussões de conflito, gerencia o tempo (<em>timebox</em>) e assegura o bom andamento da reunião.</li>\n<li><strong>Revisores</strong>: Especialistas técnicos ou de negócio que inspecionam o artefato em busca de defeitos.</li>\n<li><strong>Redator (<em>Scribe</em>)</strong>: Documenta todos os defeitos, dúvidas e decisões tomadas durante a reunião de revisão.</li>\n</ul>\n<hr/>\n<h2>3. Tipos de Revisão</h2>\n<p>O Syllabus CTFL v4.0 classifica as revisões em 4 tipos principais, ordenadas do menor ao maior grau de formalidade:</p>\n<h3>3.1 Revisão Informal (<em>Informal Review</em>)</h3>\n<ul>\n<li><strong>Formalidade</strong>: Nula ou muito baixa.</li>\n<li><strong>Características</strong>: Duas pessoas revisando um código/requisito (ex.: <em>Pair Programming</em> ou envio casual por mensagem). Não exige processo formal, reunião ou relatório.</li>\n</ul>\n<h3>3.2 Walkthrough (Passagem Guiada)</h3>\n<ul>\n<li><strong>Formalidade</strong>: Baixa a média.</li>\n<li><strong>Características</strong>: Conduzida pelo <strong>próprio Autor</strong>. O autor guia os participantes através do documento, explicando a lógica e coletando feedback. Útil para transmitir conhecimento e validar entendimento.</li>\n</ul>\n<h3>3.3 Revisão Técnica (<em>Technical Review</em>)</h3>\n<ul>\n<li><strong>Formalidade</strong>: Média a alta.</li>\n<li><strong>Características</strong>: Conduzida por especialistas técnicos (arquitetos, engenheiros seniores). Foca em avaliar a viabilidade técnica, consistência arquitetural e conformidade com padrões. Pode ter ou não um moderador.</li>\n</ul>\n<h3>3.4 Inspeção (<em>Inspection</em>)</h3>\n<ul>\n<li><strong>Formalidade</strong>: Máxima.</li>\n<li><strong>Características</strong>: O tipo mais rigoroso de revisão. Liderada por um <strong>Facilitador (Moderador) treinado</strong> (que não é o autor). Utiliza papéis estritos, <em>checklists</em>, métricas e critérios rígidos de entrada e saída.</li>\n</ul>\n<hr/>\n<h2>4. Técnicas de Revisão</h2>\n<p>Como os revisores devem analisar o documento durante a revisão individual?</p>\n<ol>\n<li><strong>Ad Hoc</strong>: Os revisores leem o documento sem nenhuma orientação prévia. Altamente dependente da habilidade individual (pode gerar registros duplicados).</li>\n<li><strong>Baseada em Checklists</strong>: Os revisores usam uma lista pré-definida de perguntas/critérios para guiar a busca por problemas comuns.</li>\n<li><strong>Cenários e Dry-Runs</strong>: Os revisores executam simulações mentais guiadas por cenários de uso para verificar o comportamento descrito.</li>\n<li><strong>Baseada em Papéis (<em>Role-Based</em>)</strong>: O revisor analisa o documento assumindo a perspectiva de um papel específico (ex.: administrador de banco de dados, usuário final, analista de segurança).</li>\n<li><strong>Baseada em Perspectivas (<em>Perspective-Based Reading - PBR</em>)</strong>: A técnica mais eficaz segundo estudos. Cada revisor adota a visão de um stakeholder diferente (ex.: testador, desenvolvedor, designer) e tenta construir um produto derivado a partir do documento.</li>\n</ol>\n<hr/>\n<h2>5. Análise Estática Automatizada</h2>\n<p>Ferramentas de análise estática examinam o código-fonte ou modelos sem executá-los.</p>\n<h3>Benefícios da Análise Estática</h3>\n<ul>\n<li>Identifica defeitos difíceis de encontrar em testes dinâmicos (ex.: vazamentos de memória, variáveis não inicializadas, código morto).</li>\n<li>Identifica <strong>vulnerabilidades de segurança</strong> (SAST - <em>Static Application Security Testing</em>).</li>\n<li>Garante a conformidade com regras de codificação (<em>linters</em>, SonarQube).</li>\n<li>Avalia métricas de código (ex.: <strong>Complexidade Ciclomática de Cyclomatic Complexity</strong>).</li>\n</ul>",
  "4": "<h1>📚 Capítulo 4: Análise e Modelagem de Testes (Syllabus CTFL v4.0)</h1>\n<p>Este capítulo apresenta as técnicas de teste utilizadas para derivar condições de teste, casos de teste e dados de teste. No Syllabus CTFL 4.0, as técnicas são classificadas em quatro categorias: <strong>Caixa-Preta</strong>, <strong>Caixa-Branca</strong>, <strong>Baseadas na Experiência</strong> e <strong>Baseadas na Colaboração</strong>.</p>\n<hr/>\n<h2>1. Categorias de Técnicas de Teste</h2>\n<div class=\"table-responsive\"><table class=\"reader-table\"><thead><tr>\n<th>Categoria</th>\n<th>Base Principal</th>\n<th>Foco / Abordagem</th>\n</tr></thead><tbody>\n<tr>\n<td><strong>Caixa-Preta (Baseadas na Especificação)</strong></td>\n<td>Requisitos, especificações, estórias de usuário, modelos.</td>\n<td>Analisa entradas e saídas sem conhecimento da estrutura interna do código.</td>\n</tr>\n<tr>\n<td><strong>Caixa-Branca (Baseadas na Estrutura)</strong></td>\n<td>Código-fonte, arquitetura, fluxo de controle.</td>\n<td>Examina a estrutura interna e o fluxo lógico do software.</td>\n</tr>\n<tr>\n<td><strong>Baseadas na Experiência</strong></td>\n<td>Conhecimento prévio, intuição e experiência do testador.</td>\n<td>Identifica falhas com base em histórico de erros e comportamento humano.</td>\n</tr>\n<tr>\n<td><strong>Baseadas na Colaboração</strong></td>\n<td>Comunicação e alinhamento entre o time de desenvolvimento, PO e testador.</td>\n<td>Deriva testes a partir de critérios de aceite e estórias de usuário em conjunto.</td>\n</tr>\n</tbody></table></div>\n<hr/>\n<h2>2. Técnicas de Caixa-Preta (<em>Black-Box</em>)</h2>\n<h3>2.1 Partição de Equivalência (PE - <em>Equivalence Partitioning</em>)</h3>\n<p>Divide os dados de entrada/saída em grupos (partições) que se espera que sejam processados da mesma forma pelo sistema.</p>\n<ul>\n<li><strong>Partição Válida</strong>: Contém valores aceitos pelo sistema.</li>\n<li><strong>Partição Inválida</strong>: Contém valores rejeitados pelo sistema.</li>\n<li><strong>Regra</strong>: Testa-se ao menos <strong>um valor representativo</strong> de cada partição para atingir 100% de Cobertura de PE.</li>\n</ul>\n<p>$$\\text{Cobertura de PE} = \\frac{\\text{Número de partições exercitadas}}{\\text{Número total de partições identificadas}} \\times 100\\%$$</p>\n<hr/>\n<h3>2.2 Análise de Valor Limite (AVL - <em>Boundary Value Analysis</em>)</h3>\n<p>Foca nos limites (fronteiras) das partições de equivalência, onde estatisticamente ocorre a maior concentração de defeitos.</p>\n<ul>\n<li><strong>AVL de 2 Valores (Padrão)</strong>:</li>\n<li>Para cada limite, testa-se o próprio <strong>valor de fronteira</strong> e seu <strong>vizinho mais próximo fora da partição</strong>.</li>\n<li><em>Exemplo</em>: Um campo aceita valores inteiros de $18$ a $60$.</li>\n<li>Limite Inferior ($18$): Testa-se $18$ (válido) e $17$ (inválido).</li>\n<li>Limite Superior ($60$): Testa-se $60$ (válido) e $61$ (inválido).</li>\n<li><strong>Valores testados</strong>: $\\{17, 18, 60, 61\\}$.</li>\n</ul>\n<ul>\n<li><strong>AVL de 3 Valores</strong>:</li>\n<li>Para cada limite, testa-se o <strong>valor de fronteira</strong>, o <strong>vizinho imediatamente abaixo</strong> e o <strong>vizinho imediatamente acima</strong>.</li>\n<li><em>Exemplo</em> ($18$ a $60$):</li>\n<li>Limite Inferior ($18$): $17, 18, 19$.</li>\n<li>Limite Superior ($60$): $59, 60, 61$.</li>\n<li><strong>Valores testados</strong>: $\\{17, 18, 19, 59, 60, 61\\}$.</li>\n</ul>\n<hr/>\n<h3>2.3 Tabela de Decisão (<em>Decision Table Testing</em>)</h3>\n<p>Técnica ideal para analisar combinações complexas de condições lógicas (regras de negócio).</p>\n<ul>\n<li>Se houver $N$ condições binárias (Verdadeiro/Falso), a tabela completa possuirá $2^N$ colunas de regras.</li>\n</ul>\n<div class=\"table-responsive\"><table class=\"reader-table\"><thead><tr>\n<th>Componente</th>\n<th>Descrição</th>\n</tr></thead><tbody>\n<tr>\n<td><strong>Condições</strong></td>\n<td>Entradas ou estados do sistema (V / F).</td>\n</tr>\n<tr>\n<td><strong>Ações</strong></td>\n<td>Saídas esperadas ou operações a serem executadas.</td>\n</tr>\n<tr>\n<td><strong>Regras</strong></td>\n<td>Cada coluna representa uma combinação única de condições e suas ações resultantes.</td>\n</tr>\n</tbody></table></div>\n<hr/>\n<h3>2.4 Teste de Transição de Estados (<em>State Transition Testing</em>)</h3>\n<p>Utilizado quando o comportamento do sistema depende do seu estado atual e de eventos históricos.</p>\n<ul>\n<li><strong>Elementos</strong>: Estados, Eventos (gatilhos), Ações e Transições.</li>\n<li><strong>Cobertura de 1-Switch (Transição Única)</strong>: Garante que todas as transições diretas válidas e inválidas entre estados sejam testadas.</li>\n</ul>\n<hr/>\n<h2>3. Técnicas de Caixa-Branca (<em>White-Box</em>)</h2>\n<p>As técnicas de caixa-branca medem a extensão em que a estrutura do código foi exercitada pela suíte de teste.</p>\n<h3>3.1 Cobertura de Instruções / Sentenças (<em>Statement Coverage</em>)</h3>\n<p>Mede a porcentagem de instruções executáveis exercitadas pelos testes:</p>\n<p>$$\\text{Cobertura de Sentença} = \\frac{\\text{Número de instruções executadas}}{\\text{Número total de instruções executáveis}} \\times 100\\%$$</p>\n<hr/>\n<h3>3.2 Cobertura de Decisões / Ramos (<em>Decision / Branch Coverage</em>)</h3>\n<p>Mede a porcentagem de ramificações de decisão (saídas Verdadeiro e Falso) exercitadas pelos testes:</p>\n<p>$$\\text{Cobertura de Decisão} = \\frac{\\text{Número de resultados de decisão exercitados}}{\\text{Número total de resultados de decisão possíveis}} \\times 100\\%$$</p>\n<hr/>\n<h3>3.3 Relação Fundamental entre Sentença e Decisão</h3>\n<blockquote class=\"alert-box\"><p>[!IMPORTANT]</p></blockquote>\n<blockquote class=\"alert-box\"><p><strong>100% de Cobertura de Decisão GARANTE 100% de Cobertura de Sentença.</strong></p></blockquote>\n<blockquote class=\"alert-box\"><p>O inverso <strong>NÃO</strong> é verdadeiro! Uma suíte que atinge 100% de Sentença pode não cobrir ramificações falsas de blocos <code>if</code> sem <code>else</code>.</p></blockquote>\n<hr/>\n<h2>4. Técnicas Baseadas na Experiência</h2>\n<ol>\n<li><strong>Suposição de Erro (<em>Error Guessing</em>)</strong>: O testador antecipa erros humanos comuns e defeitos com base no seu conhecimento técnico acumulado e histórico de falhas passadas.</li>\n<li><strong>Teste Exploratório (<em>Exploratory Testing</em>)</strong>: Teste dinâmico onde o projeto, execução e aprendizado ocorrem simultaneamente. É estruturado através de <strong>Cartas de Teste (<em>Test Charters</em>)</strong> com limites de tempo definidos (<em>timeboxing</em>).</li>\n<li><strong>Teste Baseado em Checklists</strong>: Testes executados consultando uma lista consolidada de verificações genéricas ou específicas de domínio.</li>\n</ol>\n<hr/>\n<h2>5. Técnicas Baseadas na Colaboração (CTFL 4.0)</h2>\n<p>Em equipes ágeis, a modelagem de teste ocorre via colaboração direta:</p>\n<h3>5.1 Histórias de Usuário e Critérios de Aceite</h3>\n<ul>\n<li><strong>Critério INVEST</strong>: Uma História de Usuário deve ser <strong>I</strong>ndependente, <strong>N</strong>egociável, <strong>V</strong>aliosa, <strong>E</strong>stimável, <strong>S</strong>mall (Pequena) e <strong>T</strong>estável.</li>\n<li><strong>Critérios de Aceite</strong>: Definem as condições que a estória deve satisfazer para ser aceita pelo Product Owner (frequentemente escritos no formato BDD: <em>Given / When / Then</em>).</li>\n</ul>\n<h3>5.2 Desenvolvimento Guiado por Testes de Aceite (ATDD)</h3>\n<p>Técnica colaborativa onde a equipe (Três Amigos: Dev, Tester, PO) escreve os casos de teste de aceite <strong>antes</strong> que o código seja desenvolvido, garantindo um entendimento compartilhado dos requisitos.</p>",
  "5": "<h1>📚 Capítulo 5: Gerenciamento das Atividades de Teste (Syllabus CTFL v4.0)</h1>\n<p>Este capítulo trata da liderança, planejamento, estimativa, estratégia baseada em riscos, monitoramento, controle e gestão de defeitos durante o ciclo de testes.</p>\n<hr/>\n<h2>1. Planejamento e Estratégia de Teste</h2>\n<p>O planejamento de teste define o escopo, a abordagem, os recursos e o cronograma das atividades de QA.</p>\n<h3>1.1 Conteúdo de um Plano de Teste (Norma ISO/IEC/IEEE 29119-3)</h3>\n<ul>\n<li>Escopo e objetivos do teste.</li>\n<li>Riscos de produto e riscos de projeto.</li>\n<li>Abordagem de teste (estratégia).</li>\n<li>Critérios de entrada e critérios de saída (<em>Definition of Ready</em> / <em>Definition of Done</em>).</li>\n<li>Cronograma, marcos (<em>milestones</em>) e estimativa de esforço.</li>\n<li>Papéis e responsabilidades na equipe.</li>\n<li>Necessidades do ambiente de teste e <em>testware</em>.</li>\n</ul>\n<h3>1.2 Estratégias de Teste (Abordagens)</h3>\n<div class=\"table-responsive\"><table class=\"reader-table\"><thead><tr>\n<th>Estratégia</th>\n<th>Descrição</th>\n</tr></thead><tbody>\n<tr>\n<td><strong>Analítica</strong></td>\n<td>Baseada em análise formal de riscos (<em>Risk-Based Testing</em>) ou análise de requisitos.</td>\n</tr>\n<tr>\n<td><strong>Baseada em Modelos</strong></td>\n<td>Constrói modelos do sistema (ex.: diagramas de transição de estados) para guiar o teste.</td>\n</tr>\n<tr>\n<td><strong>Metodológica</strong></td>\n<td>Utiliza suítes de teste padronizadas ou listas de verificação de falhas conhecidas.</td>\n</tr>\n<tr>\n<td><strong>Conforme Processo / Regulatória</strong></td>\n<td>Segue normas de padrões da indústria (ex.: ISO 26262, DO-178C, FDA).</td>\n</tr>\n<tr>\n<td><strong>Consultiva / Dirigida</strong></td>\n<td>Orientada pelas diretrizes e conselhos de especialistas técnicos ou usuários.</td>\n</tr>\n<tr>\n<td><strong>Aversa à Regressão</strong></td>\n<td>Foca em automatizar a suíte de testes existente para evitar quebras por novas alterações.</td>\n</tr>\n<tr>\n<td><strong>Reativa</strong></td>\n<td>Baseada em reação em tempo real durante a execução (ex.: testes exploratórios).</td>\n</tr>\n</tbody></table></div>\n<hr/>\n<h2>2. Critérios de Entrada e Saída (DoR / DoD)</h2>\n<p>Em metodologias ágeis, os critérios de entrada e saída correspondem às definições de pronto e concluído:</p>\n<ul>\n<li><strong>Critérios de Entrada (<em>Definition of Ready - DoR</em>)</strong>: Pré-condições necessárias para iniciar com segurança a fase ou execução de testes (ex.: ambiente configurado, dados de teste disponíveis, estória aprovada).</li>\n<li><strong>Critérios de Saída (<em>Definition of Done - DoD</em>)</strong>: Condições mínimas necessárias para declarar uma atividade ou ciclo de teste concluído com sucesso (ex.: $100\\%$ das suítes de alta prioridade executadas, taxa de aprovação $\\ge 95\\%$, sem defeitos críticos abertos).</li>\n</ul>\n<hr/>\n<h2>3. Estimativa e Monitoramento de Testes</h2>\n<h3>3.1 Técnicas de Estimativa</h3>\n<ol>\n<li><strong>Baseada em Métricas</strong>: Utiliza dados históricos de projetos anteriores (ex.: número de testes executados por dia, densidade de defeitos).</li>\n<li><strong>Baseada em Especialistas</strong>: Baseada na experiência dos membros da equipe (ex.: técnica <em>Wideband Delphi</em> ou <em>Planning Poker</em>).</li>\n</ol>\n<h3>3.2 Métricas de Teste</h3>\n<ul>\n<li><strong>Progresso da Execução</strong>: Percentual de testes passados, falhados, bloqueados e pendentes.</li>\n<li><strong>Densidade de Defeitos</strong>: Número de defeitos por KLOC (mil linhas de código) ou por História de Usuário.</li>\n<li><strong>Cobertura</strong>: Porcentagem de requisitos, códigos ou riscos exercitados pelos testes.</li>\n</ul>\n<hr/>\n<h2>4. Gerenciamento de Riscos</h2>\n<p>O risco é a possibilidade de ocorrência de um evento futuro com consequências negativas, mensurado por:</p>\n<p>$$\\text{Nível de Risco} = \\text{Probabilidade (Verossimilhança)} \\times \\text{Impacto}$$</p>\n<pre class=\"code-block mermaid\"><code>\nquadrantChart\ntitle Matriz de Avaliação de Riscos\nx-axis Baixa Probabilidade --&gt; Alta Probabilidade\ny-axis Baixo Impacto --&gt; Alto Impacto\nquadrant-1 Testar Primeiro (Prioridade Máxima)\nquadrant-2 Prioridade Média-Alta\nquadrant-3 Baixa Prioridade\nquadrant-4 Prioridade Média\n</code></pre>\n<h3>4.1 Risco de Produto vs. Risco de Projeto</h3>\n<ul>\n<li><strong>Risco de Produto (Risco de Qualidade)</strong>: Relaciona-se com falhas no comportamento do software (ex.: cálculo de juros incorreto, vazamento de dados, resposta lenta sob carga).</li>\n<li><strong>Risco de Projeto (Risco de Gestão)</strong>: Relaciona-se com a entrega e operação do projeto (ex.: atraso na entrega do hardware de rede, falta de pessoal qualificado, estouro de orçamento).</li>\n</ul>\n<h3>4.2 Teste Baseado em Riscos (<em>Risk-Based Testing - RBT</em>)</h3>\n<p>No RBT, os riscos de produto orientam a priorização e alocação do esforço de teste:</p>\n<ol>\n<li>Módulos com <strong>maior risco (Alto Impacto + Alta Probabilidade)</strong> são desenvolvidos e testados <strong>primeiro</strong>.</li>\n<li>Suítes de teste de alto risco recebem maior rigor e atenção na automação.</li>\n</ol>\n<hr/>\n<h2>5. Gerenciamento de Defeitos</h2>\n<p>Um Relatório de Defeitos (<em>Defect Report</em>) deve ser registrado de forma clara, objetiva e construtiva.</p>\n<h3>5.1 Estrutura Essencial de um Relatório de Defeitos</h3>\n<ul>\n<li><strong>ID e Título Conciso</strong>: Identificação única e descrição sumarizada do problema.</li>\n<li><strong>Ambiente e Versão</strong>: Sistema operacional, navegador, versão do código e banco de dados.</li>\n<li><strong>Passos para Reproduzir</strong>: Instruções detalhadas passo a passo para replicar a falha.</li>\n<li><strong>Resultado Esperado vs. Resultado Atual</strong>: Comportamento especificado vs. comportamento observado.</li>\n<li><strong>Evidências</strong>: Capturas de tela, logs do servidor, rastros de stack (<em>stack trace</em>).</li>\n<li><strong>Gravidade (<em>Severity</em>)</strong>: Impacto técnico do defeito no funcionamento do sistema.</li>\n<li><strong>Prioridade (<em>Priority</em>)</strong>: Urgência de negócio para a correção do defeito.</li>\n</ul>\n<h3>5.2 Ciclo de Vida do Defeto</h3>\n<pre class=\"code-block mermaid\"><code>\nstateDiagram-v2\n[*] --&gt; Novo: Reportado\nNovo --&gt; Aberto: Validado\nAberto --&gt; Corrigido: Dev ajustou\nCorrigido --&gt; Re_testando: QA verifica\nRe_testando --&gt; Fechado: Sucesso\nRe_testando --&gt; Aberto: Falhou\nNovo --&gt; Rejeitado: Inválido / Duplicado\n</code></pre>",
  "6": "<h1>📚 Capítulo 6: Ferramentas de Teste (Syllabus CTFL v4.0)</h1>\n<p>Este capítulo examina o ecossistema de <strong>ferramentas de teste</strong>, suas categorias, os benefícios e riscos da automação, e a estratégia de introdução de novas ferramentas na organização através de <strong>projetos piloto</strong>.</p>\n<hr/>\n<h2>1. Classificação das Ferramentas de Teste</h2>\n<p>No Syllabus CTFL 4.0, as ferramentas de teste são classificadas de acordo com a atividade do processo de teste que apoiam:</p>\n<h3>1.1 Ferramentas de Apoio à Gestão</h3>\n<ul>\n<li><strong>Gestão de Testes e ALM</strong>: Gerenciam planos de teste, casos de teste, suítes de teste e rastreabilidade (ex.: TestRail, Zephyr, Xray).</li>\n<li><strong>Gestão de Defeitos / Incidentes</strong>: Registram e acompanham o ciclo de vida dos defeitos (ex.: Jira, Bugzilla).</li>\n<li><strong>Gestão de Configuração e Integração Contínua</strong>: Controlam versões de código e automação de compilações/pipelines (ex.: Git, GitHub, GitLab, Jenkins).</li>\n</ul>\n<h3>1.2 Ferramentas de Apoio ao Teste Estático</h3>\n<ul>\n<li><strong>Análise Estática de Código (SAST)</strong>: Encontram defeitos e vulnerabilidades de segurança no código sem executá-lo (ex.: SonarQube, Checkmarx, ESLint).</li>\n<li><strong>Ferramentas de Revisão</strong>: Apoiam fluxos de trabalho de revisão por pares e aprovações de pull requests (ex.: GitHub PRs, Crucible).</li>\n</ul>\n<h3>1.3 Ferramentas de Modelagem e Dados de Teste</h3>\n<ul>\n<li><strong>Test Design / Model-Based Testing (MBT)</strong>: Geram casos de teste a partir de modelos formais.</li>\n<li><strong>Geradores de Dados de Teste</strong>: Criam conjuntos de dados sintéticos ou mascarados respeitando normas como LGPD/GDPR.</li>\n</ul>\n<h3>1.4 Ferramentas de Execução e Registro</h3>\n<ul>\n<li><strong>Automação de Execução de Testes</strong>: Executam testes simulando interações de usuário ou chamadas de API (ex.: Selenium, Cypress, Playwright, Appium, Postman, RestAssured).</li>\n<li><strong>Frameworks de Testes Unitários</strong>: Apoiam a escrita e execução de testes em nível de código (ex.: JUnit, NUnit, PyTest).</li>\n</ul>\n<h3>1.5 Ferramentas de Desempenho e Monitoramento</h3>\n<ul>\n<li><strong>Teste de Carga e Estresse</strong>: Simulam múltiplos usuários simultâneos para avaliar a capacidade do sistema (ex.: Apache JMeter, Gatling, K6).</li>\n<li><strong>Monitoramento e Observabilidade (APM)</strong>: Acompanham a saúde do sistema em produção (ex.: New Relic, Datadog, Prometheus).</li>\n</ul>\n<hr/>\n<h2>2. Benefícios e Riscos da Automação de Teste</h2>\n<blockquote class=\"alert-box\"><p>[!IMPORTANT]</p></blockquote>\n<blockquote class=\"alert-box\"><p><strong>A tecnologia não substitui a inteligência humana.</strong> A automação executa instruções predefinidas com alta velocidade, mas a análise crítica e o teste exploratório continuam dependendo do intelecto humano.</p></blockquote>\n<h3>2.1 Benefícios da Automação</h3>\n<ul>\n<li><strong>Repetibilidade e Consistência</strong>: Executa os testes exatamente da mesma forma, reduzindo falhas humanas.</li>\n<li><strong>Velocidade e Eficiência</strong>: Permite a execução rápida de grandes suítes de testes de regressão em pipelines de CI/CD.</li>\n<li><strong>Feedback Imediato</strong>: Notifica desenvolvedores sobre quebras de código em minutos.</li>\n<li><strong>Melhor Uso dos Recursos</strong>: Libera os testadores de tarefas manuais repetitivas para focarem em testes exploratórios de alto valor.</li>\n</ul>\n<h3>2.2 Riscos Principais da Automação</h3>\n<ul>\n<li><strong>Expectativas Irreais</strong>: Acreditar que a ferramenta resolverá todos os problemas de qualidade ou eliminará a necessidade de testadores.</li>\n<li><strong>Subestimar o Custo de Manutenção</strong>: Scripts de teste automatizados exigem manutenção contínua conforme a aplicação evolui. Se o custo de manutenção for superior ao ganho de tempo, o ROI será negativo.</li>\n<li><strong>Instabilidade de Testes (<em>Flaky Tests</em>)</strong>: Testes automatizados que passam e falham aleatoriamente sem alteração real de código, destruindo a confiança da equipe na suíte.</li>\n<li><strong>Desacoplamento de Processos</strong>: Adquirir uma ferramenta complexa para a qual a equipe não possui treinamento ou capacidade técnica.</li>\n</ul>\n<hr/>\n<h2>3. Projeto Piloto para Seleção de Ferramentas</h2>\n<p>Antes de adotar uma nova ferramenta de teste em toda a organização, deve-se realizar um <strong>Projeto Piloto</strong> em pequena escala.</p>\n<h3>Objetivos Principais do Projeto Piloto</h3>\n<ol>\n<li><strong>Conhecer a Ferramenta em Detalhes</strong>: Entender seus recursos, limitações e curva de aprendizado.</li>\n<li><strong>Avaliar o Ajuste à Organização</strong>: Verificar como a ferramenta se integra com a arquitetura existente, ferramentas de CI/CD e processos atuais.</li>\n<li><strong>Estabelecer Padrões de Uso</strong>: Definir convenções de código, diretrizes de manutenção e estruturas de pastas para os scripts.</li>\n<li><strong>Avaliar a Viabilidade Financeira e ROI</strong>: Estimar se o benefício compensa os custos de licença, infraestrutura e treinamento.</li>\n</ol>\n<hr/>\n<h2>4. Fatores Críticos de Sucesso na Implementação</h2>\n<ul>\n<li><strong>Implantação Gradual (Roll-out Incremental)</strong>: Introduzir a ferramenta aos poucos, equipe por equipe.</li>\n<li><strong>Treinamento Contínuo</strong>: Capacitar os membros do time no uso correto da ferramenta e nas boas práticas de codificação de testes.</li>\n<li><strong>Suporte da Liderança</strong>: Garantir o alinhamento e apoio da gestão para a alocação de tempo de manutenção dos scripts.</li>\n<li><strong>Coleta de Métricas</strong>: Monitorar o uso real e os resultados da automação para demonstrar valor à organização.</li>\n</ul>"
};
...
// Current Active Chapter Reader State
...
function initReaderModal() {
  ...
  // Attach click to all chapter cards open buttons
  document.querySelectorAll('.btn-open-chapter').forEach(btn => {
    btn.addEventListener('click', (e) => {
      e.preventDefault();
      const capNum = parseInt(btn.getAttribute('data-chapter'));
      openReaderModal(capNum);
    });
  });
  ...
  prevBtn?.addEventListener('click', () => {
    if (currentReaderChapter > 1) {
      openReaderModal(currentReaderChapter - 1);
    }
  });

  nextBtn?.addEventListener('click', () => {
    if (currentReaderChapter < 6) {
      openReaderModal(currentReaderChapter + 1);
    }
  });
}

function openReaderModal(chapterNum) {
  currentReaderChapter = chapterNum;
  const modal = document.getElementById('reader-modal');
  const badge = document.getElementById('modal-chapter-badge');
  const title = document.getElementById('modal-chapter-title');
  const content = document.getElementById('modal-reader-content');
  const prevBtn = document.getElementById('btn-prev-chapter');
  const nextBtn = document.getElementById('btn-next-chapter');
  ...
  const names = {
    ...
    2: "Testes no Ciclo de Vida do SDLC",
    3: "Teste Estático",
    4: "Análise e Modelagem de Testes",
    5: "Gerenciamento das Atividades",
    6: "Ferramentas de Teste"
  };

  if (badge) badge.innerText = `Capítulo 0${chapterNum}`;
  if (title) title.innerText = names[chapterNum] || `Capítulo ${chapterNum}`;
  
  content.innerHTML = CHAPTER_SUMMARIES[chapterNum] || "<p>Conteúdo não encontrado.</p>";
  content.scrollTop = 0;

  if (prevBtn) prevBtn.disabled = chapterNum === 1;
  if (nextBtn) nextBtn.disabled = chapterNum === 6;

  modal.classList.remove('hidden');
  
  // Track visited chapter
  stats.visitedChapters.add(chapterNum);
  saveStats();
  updateProgress();
}
...
// Mobile & Tablet Sidebar Navigation Toggle
